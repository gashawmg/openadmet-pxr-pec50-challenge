...
const cards=[{lbl:"Final Rank",val:"#9",sub:"Phase 2 leaderboard"},{lbl:"Phase 1 Rank",val:"#39",sub:"30-place improvement"},{lbl:"Final Blend",val:"75/15/10",sub:"pp50 / p13d / UniMol"},{lbl:"Tools",val:"Open-source",sub:"Chemprop · UniMol · RDKit"}];
...
s.addNotes("Title: PXR pEC50 prediction, OpenADMET blind challenge. Final rank #9/100+ qualifying teams (Phase 2 leaderboard). Phase 1 rank 39. 3-model ensemble, all open-source.");}
...
{const s=ss();
addHdr(s,"FINAL SUBMISSION","Phase 2 Leaderboard — Rank #9 / 100+ Teams");
const fm=[{lbl:"Final LB Rank",val:"#9",hi:true,sub:"of 100+ qualifying teams"},{lbl:"LB RAE",val:"0.5841",hi:false,sub:"Phase 2 leaderboard"},{lbl:"LB MAE",val:"0.4213",hi:false,sub:"Phase 2 leaderboard"},{lbl:"LB Spearman",val:"0.8028",hi:false,sub:"rank-order correlation"}];
fm.forEach((m,i)=>{
...
const det=[["File","submission_blend_751510.csv"],["Compounds","513 total (253 Set 1 + 260 Set 2)"],["Blend","75% pp50 + 15% p13d + 10% UniMol"],["LB Rank","#9 / 100+ qualifying teams"],["LB RAE","0.5841  ·  LB MAE 0.4213"],["LB Spearman","0.8028  ·  LB R² 0.5528"],["Holdout-30 RAE","0.4471 (proxy, Set 1 labels)"]];
...
s.addNotes("Final submission: LB rank #9/100+, RAE 0.5841, MAE 0.4213, Spearman 0.8028. Holdout-30 proxy was 0.4471.");}
...
s.addChart(pres.charts.BAR,[
  {name:"MAE",labels:["Gashaw  (#9)","matcha-croissant  (#1)"],values:[0.4213,0.4061]},
...
const h2h=[
  {title:"Test set too small to separate close competitors",body:"260 Set 2 compounds with MAE SD ~0.029. All top-9 entries fall within one bootstrap SD of each other — statistically a single cluster."},
...
const cols=[
  {title:"Achievements",color:C.mint,items:["Phase 2 final rank #9 / 100+ qualifying teams · LB MAE 0.4213 · Spearman 0.8028","Phase 1 rank #39 → Phase 2 rank #9 — 30-place improvement, open-source tools only","Asymmetric BCE reduces inactive over-prediction bias: +0.965 → +0.788 units","Phase 2 expands prediction range: floor 3.07→2.73, ceiling 5.80→6.00"]},
